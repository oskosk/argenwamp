...
(function($) {
  ...
  Argenmapvis.prototype = {
    ...
    magic: function() {
      ...
      {
        var vistas = [{
          lat: _this.opts.vistaInicial.lat,
          lng: _this.opts.vistaInicial.lng,
          zoom: parseInt(_this.opts.vistaInicial.zoom),
          nombre: "[ Vista inicial ]"
        }, {
          lat: -34.000000,
          lng: -59,
          zoom: 3,
